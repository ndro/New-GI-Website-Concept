		...
		<div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title">PUBLISHED POST</h3>                                    
				</div><!-- /.box-header -->
					...
					<table id="list_post" class="table table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td><span class="label label-primary">Pubished</span></td>
								<td style="width:180px">
									<a href="{{ action('PostController@getDetail') }}/{{ $post->id }}/published">
                                        <i class="fa fa-list"></i> Detail
                                    </a> &nbsp;&nbsp;
									<a href="{{ action('PostController@getEdit') }}/{{ $post->id }}/published">
                                        <i class="fa fa-edit"></i> Edit
                                    </a> &nbsp;&nbsp;
									<a href="{{ action('PostController@getSoftDelete') }}/{{ $post->id }}/published">
