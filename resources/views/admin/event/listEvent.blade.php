		...
		<div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title">UNPUBLISHED EVENT</h3>                                    
				</div><!-- /.box-header -->
					...
					<table id="list_event" class="table table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ isset($event->location) ? $event->location : 'Unknown'  }}</td>
								<td>{{ isset($event->guest) ? $event->guest : 'None'  }}</td>
								<td>{{ $event->end_datetime }}</td>
								<td> <span class="label label-success">Unpublished</span></td>
								<td style="width:180px">
									<a href="{{ action('EventController@getDetail') }}/{{ $event->id }}/unpublished">
                                        <i class="fa fa-list"></i> Detail
                                    </a> &nbsp;&nbsp;
									<a href="{{ action('EventController@getEdit') }}/{{ $event->id }}/unpublished">
                                        <i class="fa fa-edit"></i> Edit
                                    </a> &nbsp;&nbsp;
									<a href="{{ action('EventController@getDelete') }}/{{ $event->id }}/unpublished">
